...
def break_apart(dict_list):
    ...
    # The motivation for this is that each string in dict_list is actually
    # multiple dictionaries. We need to split these apart so that we can
    # evaluate them.
...
def fix_bad_keys(beer_dicts):
    ...
    # OUTPUT: list of lists of dictionaries where the key values don't contain
    # '.' and all key values are strings. This is required for MongoDB.
    fixed = []
